...
const serverURL = "https://crudcrud.com/api/df447ba4339f49ec85361682ca8b966f/restaurantOrder"
...
function handleOrder(event) {
    ...
    axios.post(serverURL, orderDetails)
        .then((result) => {
...
function displayOrderDetails(orderDetails) {
    ...
    deleteBtn.addEventListener("click", (event) => {
        axios.delete(`${serverURL}/${orderDetails._id}`)
            .then((result) => {
